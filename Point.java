...
public class Point implements Comparable{
	...
	Point otherP = (Point) otherObj;

	Double myDistance = Math.sqrt( this.xcor * this.xcor + this.ycor * this.ycor);
	Double otherDistance = Math.sqrt( otherP.xcor * otherP.xcor + otherP.ycor * otherP.ycor);
